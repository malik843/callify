...
class OverlayManager @Inject constructor(
     ...
     *
     * Skipped when Callify is the default dialer ([isDefaultDialerActive] returns true)
     * because [com.callify.ui.CallActivity] handles the call screen in that mode.
     */
    fun showLoading() {
     ...
     * and both [showLoading] and [show] return early.
     *
     * The [dismiss] path always runs regardless of this flag so teardown is
     * never skipped.
     */
